...
Encrypt a file using AES-128-GCM with a 128-bit key, 128-bit nonce, and 128-bit MAC
...
Decrypt a file using AES-128-GCM with a 128-bit key, 128-bit nonce, and 128-bit MAC
...
3. Prepare temporary file for encrypted data
...
1. Set constants for Chunk size, Nonce (IV) length, and MAC length
2. Get the secret key
3. Prepare temporary file for decrypted data
